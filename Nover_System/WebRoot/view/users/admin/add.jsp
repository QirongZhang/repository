...
<body>
	<div class="admin-add-body" style="background: #F8F8F8;">
		<div class="container-fluid">
			<h2 class="text-center" style="margin-right: 10%;">添加用户</h2>
		</div>
		<form class="form-horizontal" role="form"
			action="<%=path%>/AdminAction!add" method="post" id="form1">
			<!-- 用户账号 -->
			...
			<!-- 用户名-->
			<input name="adminBean.password" type="hidden" value="888888">
			<!-- 性别 -->
			<div class="form-group">
